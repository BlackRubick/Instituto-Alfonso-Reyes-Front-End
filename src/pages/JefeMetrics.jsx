...
export default function JefeMetrics() {
  ...
  async function fetchMetrics() {
    setLoading(true);
    try {
      const res  = await fetch(`${API_BASE_URL}/api/metrics/jefe`, {
      ...
      <header className="bg-gradient-to-br from-primary-main to-primary-dark text-white">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-bold">Jefe de Finanzas / Control de Ingresos</h1>
            <p className="text-sm text-white/60 mt-1">
              Resumen de ingresos, comparativas y distribución de pagos institucionales.
            </p>
          </div>
